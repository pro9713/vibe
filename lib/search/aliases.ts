...
export const BRAND_TAXONOMY: Record<string, string[]> = {
  ...
  Woodland: ["woodland"],
  Bata: ["bata"],
  Titan: ["titan", "fastrack", "raga"],
  Timex: ["timex"],
  Fossil: ["fossil"],
  Safari: ["safari", "safari bags"],
  "American Tourister": ["american tourister", "at", "tourister"],
  Lavie: ["lavie"],
  Baggit: ["baggit"],
  Plum: ["plum", "plum goodness"],
  Minimalist: ["minimalist", "be minimalist"],
  "Forest Essentials": ["forest essentials", "forest essential"],
  "Bombay Shaving Company": ["bombay shaving company", "bombay shaving", "bsc"],
};
